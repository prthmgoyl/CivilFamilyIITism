...
public class LinkedinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_linkedin, container, false);
        WebView linkedin = (WebView)view.findViewById(R.id.linkedin);
        linkedin.getSettings().setJavaScriptEnabled(true);
        linkedin.setWebViewClient(new WebViewClient());
        linkedin.loadUrl("https://www.linkedin.com/company/asce-student-chapter-iit-ism-dhanbad");
        return view;
    }
}