...
import com.example.civilfamilyiitism.NoticePages.NoticePageProff;
...
import com.example.civilfamilyiitism.StudentSideOnly.AscepageStudentSide;
import com.example.civilfamilyiitism.Updateclass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      try {
        ...
        img12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Professormainpage.this,ApproveChangeClassRequest.class));
